	...
	<body topMargin="0" rightMargin="0" MS_POSITIONING="GridLayout">
					...
					<TD vAlign="top">
						<FONT face="宋体">
							<P><IMG alt="" src="../../Images/Schedule_logo.gif">
								<asp:label id="Label9" runat="server" Height="22px" Width="109px" Font-Size="X-Small" Font-Bold="True">任务新增</asp:label></P>
      ...
      value="<%=UnameStr%>" name=unamestr></FONT> </P>
						<P><FONT face="宋体">
								...
								<asp:button id="btnCheck" runat="server" Width="80px" Text="检测冲突" Height="22px" CssClass="blueButtonCss"></asp:button></FONT></P>
					</TD>
