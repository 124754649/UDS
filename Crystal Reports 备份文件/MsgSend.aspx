...
class=InputCss 
readOnly type=text size=50 value="<%=SendToRealName%>" name=txtSendTo><A onclick="dialwinprocess()" href="#"><img src="../../DataImages/staff.gif" border="0"><FONT face="宋体">选择人员</FONT></A></TD>
				</TR>
				<TR height="30">
...
readOnly type=text size=50 value="<%=MobileSendToRN%>" name=txtMobileSendTo style="HEIGHT: 19px"><A onclick="dialwinprocess()" href="#"><img src="../../DataImages/staff.gif" border="0"><FONT face="宋体">选择人员</FONT></A></TD>
				</TR>
				<TR height="30">
					<TD align="right">
