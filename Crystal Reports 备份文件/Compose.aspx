										...
										<TR>
											<TD align="center">
												...
												<P><asp:button id="btnSendMail" runat="server" CssClass="ButtonCss" Text=" 发  送 "></asp:button>&nbsp;&nbsp;&nbsp;
													<INPUT class=ButtonCss style="WIDTH: 58px; HEIGHT: 20px" onclick="javascript:try {if(parent.frames.length==0) window.close();else self.location='<% Response.Write(Request.UrlReferrer); %>';} catch(e){}" type=button value=" 返  回 "></P>
											</TD>
										</TR>
									</table>
								</td>
