...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ControlClientContactHistory_thisWeek.ascx.cs" Inherits="UDS.Inc.ControlClientContactHistory_thisWeek" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
