		...
		<form id="ClientContact" method="post" encType="multipart/form-data" runat="server">
			<FONT face="宋体">
				...
				<TABLE class="gbtext" id="Table4" style="BORDER-COLLAPSE: collapse" borderColor="#93bee2"
					...
					<TR>
						<TD colSpan="4">
							<uc1:ControlClientContactHistory_thisWeek id="ControlClientContactHistory1" runat="server"></uc1:ControlClientContactHistory_thisWeek></TD>
					</TR>
					<TR>
						<TD align="center" colSpan="4"><A href="javascript:window.close();">关闭窗口</A></TD>
					</TR>
				</TABLE>
			</FONT>
		</form>
