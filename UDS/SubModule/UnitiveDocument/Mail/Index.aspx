	...
	<body leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="GridLayout">
		<form id="MailList" method="post" runat="server">
					...
					<td vAlign="bottom" height="25">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr height="25">
								...
								<td style="BACKGROUND-POSITION: left top; BACKGROUND-ATTACHMENT: fixed; BACKGROUND-REPEAT: no-repeat; HEIGHT: 25px" id=bar1 align=center width=90 
          ...
          >&nbsp;<A href="Index.aspx?FolderType=1" class="Newbutton">收件箱</A></td>
								<td style="BACKGROUND-POSITION: left top; BACKGROUND-ATTACHMENT: fixed; BACKGROUND-REPEAT: no-repeat; HEIGHT: 25px" id=bar2 align=center width=90 
          ...
          class=Newbutton>&nbsp;<A href="Index.aspx?FolderType=2" class="Newbutton">发件箱</A></td>
								<td style="BACKGROUND-POSITION: left top; BACKGROUND-ATTACHMENT: fixed; BACKGROUND-REPEAT: no-repeat; HEIGHT: 25px" id=bar3 align=center width=90 
          ...
          >&nbsp;<A href="Index.aspx?FolderType=3" class="Newbutton">废件箱</A></td>
								<td style="BACKGROUND-POSITION: left top; BACKGROUND-ATTACHMENT: fixed; BACKGROUND-REPEAT: no-repeat; HEIGHT: 25px"
									id="bar4" align="center" width="90" background="../../../images/maillistbutton1.gif">&nbsp;<A href="Compose.aspx?ClassID=0" class="Newbutton">撰写新邮件</A></td>
								<td style="BACKGROUND-POSITION: left top; BACKGROUND-ATTACHMENT: fixed; BACKGROUND-REPEAT: no-repeat; HEIGHT: 25px" id=bar5 align=center width=90 
