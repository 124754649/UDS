                        ...
                        <div class="widget-box">
                            <div class="widget-header header-color-blue">
                                ...
                                <div class="widget-toolbar">
                                    <a href="../Schedule/TaskList.aspx" target="_self" data-action="more"><i class="icon-reorder"></i>更多</a>
                    ...
                    <div class="span6">
                        <div class="widget-box">
                            <div class="widget-header header-color-blue">
                                ...
                                <div class="widget-toolbar">
                                    <a href="Mail/Index.aspx" target="_self" data-action="more"><i class="icon-reorder"></i>更多</a>
                                    <a href="Mail/Compose.aspx?ClassID=0" target="_self" data-action="new"><i class="icon-edit"></i>新建</a>
                                </div>
                            </div>
                            <div class="widget-body">
                                <div class="widget-body-inner" style="display:block">
                    ...
                    <div class="span6">
                        <div class="widget-box">
                            <div class="widget-header header-color-blue">
                                ...
                                <div class="widget-toolbar">
                                    <a href="NewDoc/Listview.aspx" target="_self" data-action="more"><i class="icon-reorder"></i>更多</a>
                                </div>
                            </div>
                            <div class="widget-body">
                                <div class="widget-main no-padding">
                    ...
                    <div class="span6">
                        <div class="widget-box">
                            <div class="widget-header header-color-blue">
                                ...
                                <div class="widget-toolbar">
                                    <a href="Approve/Listview.aspx" target="_self" data-action="more"><i class="icon-reorder"></i>更多</a>
                                </div>
                            </div>
                            <div class="widget-body">
                                <div class="widget-body-inner" style="display:block">
