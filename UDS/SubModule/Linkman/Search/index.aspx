			...
			<TABLE borderColor="#111111" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR height="30">
					...
					<TD class="GbText" background="../../../Images/treetopbg.jpg" bgColor="#e8f4ff" width="75"
						align="right" style="WIDTH: 75px">联系人管理</TD>
					<TD class="GbText" background="../../../Images/treetopbg.jpg" bgColor="#e8f4ff" align="right">&nbsp;</TD>
				</TR>
			</TABLE>
			<FONT face="宋体">
				<TABLE id="Table1" borderColor="#93bee2" cellSpacing="0" cellPadding="0" width="100%" border="0"
					...
					<TR>
						<TD colSpan="3">
							...
							<TABLE id="tbl_LinkmanSearch" borderColor="#93bee2" cellSpacing="0" cellPadding="0" width="100%"
								border="1" style="BORDER-COLLAPSE: collapse" class="GbText" runat="server">
								<TR>
									<TD align="center" height="24">姓名</TD>
									<TD height="24">
								...
								<TR>
									<TD align="center" height="24">电话</TD>
									<TD height="24">
							...
							<TABLE id="tbl_CutomSearch" borderColor="#93bee2" cellSpacing="0" cellPadding="0" width="100%"
								border="1" style="BORDER-COLLAPSE: collapse" class="GbText" runat="server">
								<TR>
									<TD align="center" height="24">姓名</TD>
									<TD height="24">
								...
								<TR>
									<TD align="center" height="24">类别</TD>
									<TD height="24">
