...
<%@ Page language="c#" Codebehind="ListView.aspx.cs" AutoEventWireup="false" Inherits="UDS.SubModule.Position.ListView" %>
...
<HTML>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="ListView" runat="server">
          ...
          background='<% Response.Write(DisplayType==1?"../../images/maillistbutton1.gif":"../../images/maillistbutton2.gif"); %>'  height="24"><asp:linkbutton id="lbOnline" runat="server"  CssClass="Newbutton">在职员工</asp:linkbutton></TD>
								<TD align="center" width="90"  background='<% Response.Write(DisplayType==0?"../../images/maillistbutton1.gif":"../../images/maillistbutton2.gif"); %>' height="24"><asp:linkbutton id="lbOffLine" runat="server"  CssClass="Newbutton">离职员工</asp:linkbutton></TD>
								<TD align="right">
									<asp:CheckBox id="cbRemind" runat="server" Font-Size="X-Small" Text="提醒公司全体员工" Width="160px" Height="16px"></asp:CheckBox>
									<asp:Button id="cmdUpdateCaste" runat="server" CssClass="redbuttoncss" Text="修改职级"></asp:Button>
									<asp:Button id="cmdNewStaff" runat="server" Text="新员工" CssClass="redbuttoncss"></asp:Button>
									<asp:Button id="cmdPositionOperate" runat="server" Text="职位操作" CssClass="redbuttoncss"></asp:Button>
