				...
				<tr>
					<td>
						<TABLE class="gbtext" id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD align="center" width="90" background="../../images/maillistbutton2.gif" height="24"><FONT face="宋体" class="Newbutton">职位操作</FONT></TD>
								<TD align="right">
									<asp:LinkButton id="lbAddPosition" runat="server">创建下级职位</asp:LinkButton>
									<asp:LinkButton id="lbDeletePosition" runat="server">删除当前职位</asp:LinkButton>
									<asp:LinkButton id="lbModifyPosition" runat="server">修改职位</asp:LinkButton>
									<asp:LinkButton id="lbMovePosition" runat="server">职位的移动</asp:LinkButton>
								</TD>
							</TR>
						</TABLE>
					</td>
				...
				<TR>
					<TD valign="top"><FONT face="宋体">
							<TABLE id="tabAdd" cellSpacing="0" cellPadding="0" width="100%" border="1" runat="server"
								...
								<TR>
									<TD style="WIDTH: 90px" height="24" bgcolor="#e8f4ff" align="right"><FONT face="宋体">&nbsp;上级职位：</FONT></TD>
									<TD id="TD1" runat="server"><FONT face="宋体">&nbsp;
											<asp:Label id="addPositionName" runat="server"></asp:Label></FONT></TD>
								</TR>
								<TR>
									<TD height="24" bgcolor="#e8f4ff" align="right"><FONT face="宋体">&nbsp;职位名称：</FONT></TD>
									<TD><FONT face="宋体">&nbsp;
								...
								<TR>
									<TD style="WIDTH: 90px" valign="top" bgcolor="#e8f4ff" align="right"><FONT face="宋体">&nbsp;职位简介：</FONT></TD>
								...
								<TR>
									<TD style="WIDTH: 90px" bgcolor="#e8f4ff" align="right"><FONT face="宋体">&nbsp;考勤时间：</FONT></TD>
									<TD>&nbsp;
										<asp:TextBox id="txtOnDutyTime" runat="server" CssClass="inputcss" Columns="10" Rows="5" Width="150px"></asp:TextBox>
										<asp:RegularExpressionValidator id="rev_OnDutyTime" runat="server" ErrorMessage="输入错误" ControlToValidate="txtOnDutyTime"
											Display="Dynamic" ValidationExpression="([0-9]|(([0-1][0-9])|([2][[0-3]))):([0-5][0-9])"></asp:RegularExpressionValidator><FONT face="宋体">-</FONT>
										<asp:TextBox id="txtOffDutyTime" runat="server" CssClass="inputcss" Columns="10" Rows="5" Width="150px"></asp:TextBox>
										<asp:RegularExpressionValidator id="rev_OffDutyTime" runat="server" ErrorMessage="输入错误" ControlToValidate="txtOffDutyTime"
											Display="Dynamic" ValidationExpression="([0-9]|(([0-1][0-9])|([2][[0-3]))):([0-5][0-9])"></asp:RegularExpressionValidator>(hh:mm)</TD>
								</TR>
								<TR>
									<TD colspan="2" align="center" height="36"><FONT id="FONT1" face="宋体" runat="server"> <INPUT class="ButtonCss " id="cmdAdd" accessKey="o" type="submit" value=" 确 定 " runat="server"
												size="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<TABLE id="tabDelete" cellSpacing="0" cellPadding="0" width="100%" border="1" runat="server"
								class="gbtext" style="BORDER-COLLAPSE: collapse" bordercolor="#93bee2">
								<TR>
									<TD style="WIDTH: 90px" bgcolor="#e8f4ff" height="24" align="right"><FONT face="宋体">&nbsp;删除职位：</FONT></TD>
									<TD>&nbsp;
										<asp:Label id="delPositionName" runat="server"></asp:Label></TD>
								</TR>
								<TR>
									<TD colspan="2" align="center" height="36"><FONT face="宋体"> <INPUT class="ButtonCss" id="cmdDelete" type="submit" value=" 删 除 " runat="server">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<TABLE id="tabModify" cellSpacing="0" cellPadding="0" width="100%" border="1" runat="server"
								class="gbtext" style="BORDER-COLLAPSE: collapse" bordercolor="#93bee2">
								<TR>
									<TD style="WIDTH: 90px" bgcolor="#e8f4ff" height="24" align="right"><FONT face="宋体">&nbsp;职位名称：</FONT></TD>
									<TD>&nbsp;
								...
								<TR>
									...
									<TD><FONT face="宋体">&nbsp;
											...
											<asp:RegularExpressionValidator id="rev_uOnDutyTime" runat="server" ErrorMessage="输入错误" ControlToValidate="txtuOnDutyTime"
											...
											<asp:RegularExpressionValidator id="rev_uOffDutyTime" runat="server" ErrorMessage="输入错误" ControlToValidate="txtuOffDutyTime"
						...
						<P><FONT face="宋体">
								<TABLE id="tabMove" cellSpacing="0" cellPadding="0" width="100%" border="1" runat="server"
									class="gbtext" style="BORDER-COLLAPSE: collapse" bordercolor="#93bee2">
									<TR>
										<TD style="WIDTH: 94px; HEIGHT: 28px" bgcolor="#e8f4ff" align="right">职位名称：</TD>
										<TD style="HEIGHT: 28px">&nbsp;
											<asp:Label id="lblPosition" runat="server" Width="213px"></asp:Label></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 94px" valign="top" bgcolor="#e8f4ff" align="right">&nbsp;移动到：</TD>
										<TD>&nbsp;
