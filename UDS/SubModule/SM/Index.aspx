...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" topmargin="0" leftmargin="0">
		<form id="Index" method="post" runat="server">
			<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111"
				width="100%" height="1">
				<tr height="30">
					<td width="3%" bgcolor="#c0d9e6" class="GbText" background="../../Images/treetopbg.jpg"><font color="#003366" size="3"><img src="../../DataImages/message2.gif" width="16" height="16"></font></td>
    ...
    >&nbsp;<A href="Index.aspx?DispType=1" class="Newbutton">我的消息</A></td>
						<td id=bar2 
    style="BACKGROUND-POSITION: left top; BACKGROUND-ATTACHMENT: fixed; BACKGROUND-REPEAT: no-repeat; HEIGHT: 25px" 
    align=center width=90 
